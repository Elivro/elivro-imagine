---
name: payload
description: Use proactively when planning or implementing anything with Payload CMS (collections, fields, hooks, access control, payload.config.ts, migrations, queries, Server Actions). Provides TypeScript patterns and standards for Payload 3.x development.
---
